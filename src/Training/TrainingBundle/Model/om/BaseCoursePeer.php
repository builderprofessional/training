...
abstract class BaseCoursePeer extends \Engine\EngineBundle\Base\EnginePeer
{
    ...
    const TABLE_NAME = 'training_course';

    /** the related Propel class for this table */
    const OM_CLASS = 'Training\\TrainingBundle\\Model\\Course';
    ...
    const DATE_MODIFIED = 'training_course.date_modified';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to training_course
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CoursePeer::TRAINING_COURSE_ID) && $criteria->keyContainsValue(CoursePeer::TRAINING_COURSE_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CoursePeer::TRAINING_COURSE_ID);
            $value = $criteria->remove(CoursePeer::TRAINING_COURSE_ID);
            if ($value) {
                $selectCriteria->add(CoursePeer::TRAINING_COURSE_ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the training_course table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CoursePeer::TRAINING_COURSE_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CoursePeer::DATABASE_NAME);
        $criteria->add(CoursePeer::TRAINING_COURSE_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CoursePeer::DATABASE_NAME);
            $criteria->add(CoursePeer::TRAINING_COURSE_ID, $pks, Criteria::IN);
