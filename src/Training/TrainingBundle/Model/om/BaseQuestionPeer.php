...
use Training\TrainingBundle\Model\map\QuestionTableMap;

abstract class BaseQuestionPeer extends \Engine\EngineBundle\Base\EnginePeer
{
    ...
    const OM_CLASS = 'Training\\TrainingBundle\\Model\\Question';
    ...
    const TRAINING_QUESTION_ID = 'training_question.training_question_id';

    /** the column name for the date_modified field */
    const DATE_MODIFIED = 'training_question.date_modified';

    /** the column name for the date_created field */
    const DATE_CREATED = 'training_question.date_created';

    /** the column name for the auth_user_id field */
    const AUTH_USER_ID = 'training_question.auth_user_id';

    /** the column name for the training_course_id field */
    const TRAINING_COURSE_ID = 'training_question.training_course_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('QuestionId', 'DateModified', 'DateCreated', 'AuthUserId', 'CourseId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('questionId', 'dateModified', 'dateCreated', 'authUserId', 'courseId', ),
        BasePeer::TYPE_COLNAME => array (QuestionPeer::TRAINING_QUESTION_ID, QuestionPeer::DATE_MODIFIED, QuestionPeer::DATE_CREATED, QuestionPeer::AUTH_USER_ID, QuestionPeer::TRAINING_COURSE_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TRAINING_QUESTION_ID', 'DATE_MODIFIED', 'DATE_CREATED', 'AUTH_USER_ID', 'TRAINING_COURSE_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('training_question_id', 'date_modified', 'date_created', 'auth_user_id', 'training_course_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('QuestionId' => 0, 'DateModified' => 1, 'DateCreated' => 2, 'AuthUserId' => 3, 'CourseId' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('questionId' => 0, 'dateModified' => 1, 'dateCreated' => 2, 'authUserId' => 3, 'courseId' => 4, ),
        BasePeer::TYPE_COLNAME => array (QuestionPeer::TRAINING_QUESTION_ID => 0, QuestionPeer::DATE_MODIFIED => 1, QuestionPeer::DATE_CREATED => 2, QuestionPeer::AUTH_USER_ID => 3, QuestionPeer::TRAINING_COURSE_ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TRAINING_QUESTION_ID' => 0, 'DATE_MODIFIED' => 1, 'DATE_CREATED' => 2, 'AUTH_USER_ID' => 3, 'TRAINING_COURSE_ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('training_question_id' => 0, 'date_modified' => 1, 'date_created' => 2, 'auth_user_id' => 3, 'training_course_id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(QuestionPeer::TRAINING_QUESTION_ID);
            $criteria->addSelectColumn(QuestionPeer::DATE_MODIFIED);
            $criteria->addSelectColumn(QuestionPeer::DATE_CREATED);
            $criteria->addSelectColumn(QuestionPeer::AUTH_USER_ID);
            $criteria->addSelectColumn(QuestionPeer::TRAINING_COURSE_ID);
        } else {
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (QuestionPeer::$instances as $instance)
        {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to training_question
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(QuestionPeer::AUTH_USER_ID, UserPeer::AUTH_USER_ID, $join_behavior);
    ...
    public static function doCountJoinCourse(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(QuestionPeer::TRAINING_COURSE_ID, CoursePeer::TRAINING_COURSE_ID, $join_behavior);
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        QuestionPeer::addSelectColumns($criteria);
        $startcol = QuestionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Question) to $obj2 (User)
    ...
    /**
     * Selects a collection of Question objects pre-filled with their Course objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Question objects.
    ...
    public static function doSelectJoinCourse(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Question) to $obj2 (Course)
                $obj2->addQuestion($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        QuestionPeer::addSelectColumns($criteria);
        $startcol2 = QuestionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Question) to the collection in $obj2 (User)
                $obj2->addQuestion($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Question) to the collection in $obj3 (Course)
    ...
    /**
     * Selects a collection of Question objects pre-filled with all related objects except User.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = QuestionPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Question) to the collection in $obj2 (Course)
                $obj2->addQuestion($obj1);
    ...
    /**
     * Selects a collection of Question objects pre-filled with all related objects except Course.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(QuestionPeer::TRAINING_QUESTION_ID) && $criteria->keyContainsValue(QuestionPeer::TRAINING_QUESTION_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.QuestionPeer::TRAINING_QUESTION_ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(QuestionPeer::TRAINING_QUESTION_ID);
            $value = $criteria->remove(QuestionPeer::TRAINING_QUESTION_ID);
            if ($value) {
                $selectCriteria->add(QuestionPeer::TRAINING_QUESTION_ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the training_question table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(QuestionPeer::TRAINING_QUESTION_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(QuestionPeer::DATABASE_NAME);
        $criteria->add(QuestionPeer::TRAINING_QUESTION_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(QuestionPeer::DATABASE_NAME);
            $criteria->add(QuestionPeer::TRAINING_QUESTION_ID, $pks, Criteria::IN);
