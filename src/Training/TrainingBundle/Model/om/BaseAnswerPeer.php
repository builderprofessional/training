...
use \PropelException;
use \PropelPDO;
use Engine\AuthBundle\Model\UserPeer;
...
use Training\TrainingBundle\Model\map\AnswerTableMap;

abstract class BaseAnswerPeer extends \Engine\EngineBundle\Base\EnginePeer
{
    ...
    const TABLE_NAME = 'training_answer';

    /** the related Propel class for this table */
    const OM_CLASS = 'Training\\TrainingBundle\\Model\\Answer';
    ...
    /** the column name for the training_answer_id field */
    const TRAINING_ANSWER_ID = 'training_answer.training_answer_id';

    /** the column name for the date_modified field */
    const DATE_MODIFIED = 'training_answer.date_modified';

    /** the column name for the date_created field */
    const DATE_CREATED = 'training_answer.date_created';

    /** the column name for the training_question_id field */
    const TRAINING_QUESTION_ID = 'training_answer.training_question_id';

    /** the column name for the auth_user_id field */
    const AUTH_USER_ID = 'training_answer.auth_user_id';
     ...
     * e.g. AnswerPeer::$fieldNames[AnswerPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('AnswerId', 'DateModified', 'DateCreated', 'QuestionId', 'AuthUserId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('answerId', 'dateModified', 'dateCreated', 'questionId', 'authUserId', ),
        BasePeer::TYPE_COLNAME => array (AnswerPeer::TRAINING_ANSWER_ID, AnswerPeer::DATE_MODIFIED, AnswerPeer::DATE_CREATED, AnswerPeer::TRAINING_QUESTION_ID, AnswerPeer::AUTH_USER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TRAINING_ANSWER_ID', 'DATE_MODIFIED', 'DATE_CREATED', 'TRAINING_QUESTION_ID', 'AUTH_USER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('training_answer_id', 'date_modified', 'date_created', 'training_question_id', 'auth_user_id', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. AnswerPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('AnswerId' => 0, 'DateModified' => 1, 'DateCreated' => 2, 'QuestionId' => 3, 'AuthUserId' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('answerId' => 0, 'dateModified' => 1, 'dateCreated' => 2, 'questionId' => 3, 'authUserId' => 4, ),
        BasePeer::TYPE_COLNAME => array (AnswerPeer::TRAINING_ANSWER_ID => 0, AnswerPeer::DATE_MODIFIED => 1, AnswerPeer::DATE_CREATED => 2, AnswerPeer::TRAINING_QUESTION_ID => 3, AnswerPeer::AUTH_USER_ID => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('TRAINING_ANSWER_ID' => 0, 'DATE_MODIFIED' => 1, 'DATE_CREATED' => 2, 'TRAINING_QUESTION_ID' => 3, 'AUTH_USER_ID' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('training_answer_id' => 0, 'date_modified' => 1, 'date_created' => 2, 'training_question_id' => 3, 'auth_user_id' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        $toNames = AnswerPeer::getFieldNames($toType);
        $key = isset(AnswerPeer::$fieldKeys[$fromType][$name]) ? AnswerPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(AnswerPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, AnswerPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return AnswerPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AnswerPeer::TRAINING_ANSWER_ID);
            $criteria->addSelectColumn(AnswerPeer::DATE_MODIFIED);
            $criteria->addSelectColumn(AnswerPeer::DATE_CREATED);
            $criteria->addSelectColumn(AnswerPeer::TRAINING_QUESTION_ID);
            $criteria->addSelectColumn(AnswerPeer::AUTH_USER_ID);
        } else {
            $criteria->addSelectColumn($alias . '.training_answer_id');
            $criteria->addSelectColumn($alias . '.date_modified');
            $criteria->addSelectColumn($alias . '.date_created');
            $criteria->addSelectColumn($alias . '.training_question_id');
            $criteria->addSelectColumn($alias . '.auth_user_id');
        }
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AnswerPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(AnswerPeer::DATABASE_NAME);
     ...
     *
     * @param      Answer $obj A Answer object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(AnswerPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(AnswerPeer::$instances[$key])) {
                return AnswerPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (AnswerPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        AnswerPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to training_answer
    ...
    public static function doCountJoinQuestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AnswerPeer::TRAINING_QUESTION_ID, QuestionPeer::TRAINING_QUESTION_ID, $join_behavior);
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(AnswerPeer::AUTH_USER_ID, UserPeer::AUTH_USER_ID, $join_behavior);
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Answer) to $obj2 (User)
                $obj2->addAnswer($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Answer) to the collection in $obj3 (User)
                $obj3->addAnswer($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptQuestion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = AnswerPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Answer) to the collection in $obj2 (User)
                $obj2->addAnswer($obj1);
    ...
    {
        return Propel::getDatabaseMap(AnswerPeer::DATABASE_NAME)->getTable(AnswerPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(AnswerPeer::TRAINING_ANSWER_ID) && $criteria->keyContainsValue(AnswerPeer::TRAINING_ANSWER_ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Answer or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(AnswerPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(AnswerPeer::TRAINING_ANSWER_ID);
            $value = $criteria->remove(AnswerPeer::TRAINING_ANSWER_ID);
            if ($value) {
                $selectCriteria->add(AnswerPeer::TRAINING_ANSWER_ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the training_answer table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(AnswerPeer::TRAINING_ANSWER_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(AnswerPeer::DATABASE_NAME);
        $criteria->add(AnswerPeer::TRAINING_ANSWER_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(AnswerPeer::DATABASE_NAME);
            $criteria->add(AnswerPeer::TRAINING_ANSWER_ID, $pks, Criteria::IN);
